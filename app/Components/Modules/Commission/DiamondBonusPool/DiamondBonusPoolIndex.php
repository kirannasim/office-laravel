...
namespace App\Components\Modules\Commission\DiamondBonusPool;
...
use App\Components\Modules\Commission\DiamondBonusPool\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\DiamondBonusPool\ModuleCore\Traits\Validations;
 ...
 */
class DiamondBonusPoolIndex extends BasicContract implements CommissionModuleInterface
{
    use Validations;
    ...
    function bootMethods(CommissionServices $commissionServices)
    {
        ...
        schedule('Diamond Pool Bonus', function () {
            $this->process();
        });
    }
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.DiamondBonusPool.Views.adminConfig', $data);
    }
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.DiamondBonusPool.Views.commissionTable', $data);
    }
}

...
namespace App\Components\Modules\Commission\PFCCommission;
...
use App\Components\Modules\Commission\PFCCommission\ModuleCore\Support\Benefit;
use App\Components\Modules\Commission\PFCCommission\ModuleCore\Traits\Hooks;
use App\Components\Modules\Commission\PFCCommission\ModuleCore\Traits\Validations;
 ...
 * @package App\Components\Modules\Commission\PFCCommission
 */
class PFCCommissionIndex extends BasicContract implements CommissionModuleInterface
{
    ...
    function adminConfig($data = [])
    {
        ...
        return view('Commission.PFCCommission.Views.adminConfig', $data);
    }
    ...
    {
        return (new Benefit($data, $this))->setReferenceData($data)->setBeneficiaries()->distribute();
    }
    ...
    function commissionTable($commissions)
    {
        ...
        return view('Commission.PFCCommission.Views.commissionTable', $data);
    }
}

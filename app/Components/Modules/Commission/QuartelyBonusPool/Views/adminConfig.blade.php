        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span aria-hidden="true"
                      class="icon-tag"></span> 5 STAR+ QUARTERY BONUS POOL [QBP]
            </div>
            <div class="panel-body">
                <div class="row form-group">
                    <div class="col-md-3">
                        <label> {{ _mt($moduleId,'QuartelyBonusPool.To_Wallet') }}</label>
                    </div>
                    ...
                    <div class="col-md-6 col-xs-6">
                        <div class="col-md-3">
                            <input type="button" id="addLevel" class="btn btn-sm green"
                                   value="{{ _mt($moduleId,'QuartelyBonusPool.Add_Level') }}"/>
                        </div>
                        <div class="col-md-4">
                            <input type="button" id="removeLevel" class="btn btn-sm red"
                                   value="{{ _mt($moduleId,'QuartelyBonusPool.Remove_Level') }}"/>
                        </div>
                    </div>
                </div>
                <div class="form-group offset4">
                    <div class="col-md-1">
                        <button type="button" value="{{ _mt($moduleId,'QuartelyBonusPool.Save') }}"
                                class="form-control ladda-button btn green button-submit" data-style="contract"
                                name="amount">{{ _mt($moduleId,'QuartelyBonusPool.Save') }}</button>
                    </div>
                </div>
            </div>
        </div>

...
trait Validations
{
    ...
    {
        return [
            'module_data.wallet' => _mt($this->moduleId, 'SponsorLevelCommission.Please_select_wallet'),
            'module_data.commission.*.required' => _mt($this->moduleId, 'SponsorLevelCommission.Please_enter_commission_rate'),
            'module_data.commission.*.numeric' => _mt($this->moduleId, 'SponsorLevelCommission.Invalid_commission_rate'),
        ];
    }
}
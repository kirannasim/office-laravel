...
namespace App\Components\Modules\General\PaymentState;

use App\Blueprint\Interfaces\Module\ModuleBasicAbstract as BasicContract;
use App\Components\Modules\General\PaymentState\ModuleCore\Traits\Hooks;
use App\Components\Modules\General\PaymentState\ModuleCore\Traits\Routes;
use Illuminate\Contracts\View\Factory;
use Illuminate\View\View;

/**
 * Class PaymentStateIndex
 * @package App\Components\Modules\General\PaymentState
 */
class PaymentStateIndex extends BasicContract
{
    use Routes, Hooks;
    ...
    function adminConfig($data = [])
    {
        ...
        return view('General.PaymentState.Views.adminConfig', $data);
    }

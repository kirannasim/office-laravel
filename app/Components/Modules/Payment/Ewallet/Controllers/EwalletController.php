...
namespace App\Components\Modules\Payment\Ewallet\Controllers;

use App\Blueprint\Services\ModuleServices;
use App\Components\Modules\Payment\Ewallet\EwalletIndex as Module;
use App\Components\Modules\Wallet\Ewallet\EwalletIndex as Wallet;
...
class EwalletController extends Controller
{
    ...
    function getTransactionPassView($verifyOnly = false, $action = 'handle')
    {
        ...
        return view('Payment.Ewallet.Views.Partials.transactionPass', $data);
    }

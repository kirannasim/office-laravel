...
namespace App\Components\Modules\Payment\SafeCharge\ModuleCore\Support\Transaction;
...
/**
 * Class SafeChargeCallback
 * @package App\Components\Modules\Payment\SafeCharge\ModuleCore\Support\Transaction
 */
class SafeChargeCallback Extends Callback
{
    /**
     * @param $response
     * @return mixed|string

        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <span aria-hidden="true"
                      class="icon-note"></span> SafeCharge Pay Configuration
            </div>
            <div class="panel-body">
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" value="{{ $config->get('merchant_id') }}" class="form-control"
                               name="module_data[merchant_id]">
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="col-md-4">
                        <input type="text" value="{{ $config->get('merchant_site_id') }}" class="form-control"
                               name="module_data[merchant_site_id]">
                    </div>
                </div>
                 <div class="form-group">
                    <label class="control-label col-md-3">
                        Merchant Test Secret
                        <span class="required" aria-required="true"> * </span>
                    </label>
                    <div class="col-md-4">
                        <input type="text" value="{{ $config->get('merchant_secret_key') }}" class="form-control"
                               name="module_data[merchant_secret_key]">
                    </div>
                </div>

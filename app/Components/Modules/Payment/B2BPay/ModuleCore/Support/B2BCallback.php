...
namespace App\Components\Modules\Payment\B2BPay\ModuleCore\Support\Transaction;
...
/**
 * Class B2BCallback
 * @package App\Components\Modules\Payment\B2BPay\ModuleCore\Support\Transaction
 */
class B2BCallback Extends Callback
{
    /**
     * @param $response
     * @return mixed|string

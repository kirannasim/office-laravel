...
namespace App\Components\Modules\Payment\ZotaPay\ModuleCore\Support\Transaction;
...
/**
 * Class ZotaCallback
 * @package App\Components\Modules\Payment\ZotaPay\ModuleCore\Support\Transaction
 */
class ZotaCallback Extends Callback
{
    /**
     * @param $response
     * @return mixed|string

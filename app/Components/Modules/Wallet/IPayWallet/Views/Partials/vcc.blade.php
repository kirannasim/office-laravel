<div class="vccWrap">
    <div class="cardWrapper">
        ...
        <div class="vccInfo">
            <div class="vccStatus">
                ...
                <span>{{ _mt($moduleId,'IPayWallet.Active') }}</span>
            </div>
        </div>
    </div>
    <div class="vccActions">
        <div class="col-md-3 col-md-offset-3 vccAction disable">
            <i class="icon-lock"></i>
            <div class="handlerInner">{{ _mt($moduleId,'IPayWallet.Disable') }}</div>
        </div>
        <div class="col-md-3 vccAction cancel">
            <i class="icon-trash"></i>
            <div class="handlerInner">{{ _mt($moduleId,'IPayWallet.Cancel') }}</div>
        </div>
    </div>
</div>
<style type="text/css">

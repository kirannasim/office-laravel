<form class="passChange col-md-12">
    ...
    <div class="inputs">
        <h2 class="heading">{{ _mt($moduleId,'IPayWallet.set_transaction_password') }}</h2>
        <div class="firstPart">
...
<script type="text/javascript">
    ...
    $('button.changePassword').click(function () {
        ...
        var post = $.post('{{ route(strtolower(getScope()).".ipaywallet.validate.change_password") }}', formData, function (response) {
            ...
            refreshAjaxData($('.transactionPassLoader'), '{!! route(strtolower(getScope()).".ipaywallet.login.password_view") !!}');
            Ladda.stopAll();

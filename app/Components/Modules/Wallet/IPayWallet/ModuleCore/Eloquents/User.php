...
namespace App\Components\Modules\Wallet\IPayWallet\ModuleCore\Eloquents;
...
class User extends \App\Eloquents\User
{
    ...
    {
        return !$data ? $this->hasOne(IPayWallet::class) : ($this->walletData()->save(new IPayWallet($data)));
    }
    ...
    function getWalletId()
    {
        ...
        return $moduleService->callModule('Wallet-IPayWallet')->moduleId;
    }

...
namespace App\Components\Modules\Wallet\IPayWallet\ModuleCore\Schema;
...
class Setup
{
    ...
    {
        if (!Schema::hasTable('ipaywallet')) {
            Schema::create('ipaywallet', function (Blueprint $table) {
                $table->increments('id');
            ...
            Schema::table('ipaywallet', function (Blueprint $table) {
    ...
    {
        Schema::dropIfExists('ipaywallet');
    }
}
...
trait Validations
{
    ...
    {
        return [
            'module_data.payout_provision.required' => _mt($this->moduleId, 'Ewallet.Please_set_payout_provision'),
            'module_data.transfer_provision.required' => _mt($this->moduleId, 'Ewallet.Please_set_transfer_provision'),
            'module_data.minimum_transfer.required' => _mt($this->moduleId, 'Ewallet.Please_set_minimum_transfer'),
            'module_data.minimum_amount.required_if' => _mt($this->moduleId, 'Ewallet.Please_enter_valid_amount'),
            'module_data.maximum_transfer.required' => _mt($this->moduleId, 'Ewallet.Please_set_maximum_transfer'),
            'module_data.maximum_transfer.required_if' => _mt($this->moduleId, 'Ewallet.Please_enter_valid_amount'),
            'module_data.cross_transfer.required' => _mt($this->moduleId, 'Ewallet.Please_set_cross_transfer_option'),
            'module_data.cross_wallets.required_if' => _mt($this->moduleId, 'Ewallet.Please_select_atleast_one_wallet'),
        ];
    }
}
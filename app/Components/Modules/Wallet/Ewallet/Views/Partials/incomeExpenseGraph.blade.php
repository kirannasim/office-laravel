...
<script type="text/javascript">
    ...
    jQuery(document).ready(function () {
        ...
        $('#incomeChart').highcharts({
            ...
            title: {
                text: "{{_mt($moduleId,'Ewallet.income_expense_overview') }}",
                x: -20 //center
            },
            /*		subtitle: {
            ...
            yAxis: {
                title: {
                    text: "{{_mt($moduleId,'Ewallet.income_expense') }}",
                },
                plotLines: [{
                    value: 0,
                    width: 1,
            ...
            series: [{
                name: "{{_mt($moduleId,'Ewallet.income') }}",
                type: 'column',
                data: JSON.parse('{!! json_encode($monthlyIncome) !!}')
            }, {
                name: "{{_mt($moduleId,'Ewallet.expense') }}",
                type: 'column',

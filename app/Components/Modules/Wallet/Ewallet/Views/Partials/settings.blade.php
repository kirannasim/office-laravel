    ...
    <div class="navWrapper setIcon">
        <ul class="navUl">
            <li data-unit="settings">
                <i class="fa fa-key"></i>
                <p>
                    @if(isset($walletSettings->transaction_password) && $walletSettings->transaction_password != null){{ _mt($moduleId,'Ewallet.change_transaction_password') }} @else {{ _mt($moduleId,'Ewallet.set_transaction_password') }} @endif
                </p>
            </li>
            <li data-unit="ipWhiteList">
                <i class="fa fa-television"></i>
                <p>{{ _mt($moduleId,'Ewallet.IP_Restriction') }}</p>
            </li>
        </ul>
    </div>

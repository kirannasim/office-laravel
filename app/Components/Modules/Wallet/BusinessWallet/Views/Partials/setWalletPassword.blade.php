<form class="passChange col-md-12">
    ...
    <div class="inputs">
        <h2 class="heading">{{ _mt($moduleId,'BusinessWallet.set_transaction_password') }}</h2>
        <div class="firstPart">
...
<script type="text/javascript">
    ...
    $('button.changePassword').click(function () {
        ...
        var post = $.post('{{ scopeRoute("businesswallet.validate.change_password") }}', formData, function (response) {
            ...
            refreshAjaxData($('.transactionPassLoader'), '{!! route(strtolower(getScope()).".businesswallet.login.password_view") !!}');
            Ladda.stopAll();

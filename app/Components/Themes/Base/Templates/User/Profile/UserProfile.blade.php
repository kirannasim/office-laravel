            ...
            <div class="profile-sidebar">
                <div class="portlet light profile-sidebar-portlet">
                    ...
                    <div class="profile-usertitle">
                        <div class="profile-usertitle-name"> {{ $profile->MetaData->firstname.' '. $profile->MetaData->lastname }} </div>
                    </div>
                    ...
                    <div class="profile-usermenu">
                        <ul class="nav profileMenu">
                            ...
                            {!! defineFilter('profileMenuItem', '', 'userProfile') !!}
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <script type="text/javascript">"use strict";
        $(function () {
            $(".ProfilemeuItem").click(function () {
                ...
                $.post('{{ route('user.profile.requestUnit') }}', {unit: unitAction}, function (data) {
        ...
        $('.saveProfilePic').click(function () {
            if ($('#proPicInput').val()) {
                $.post('{{ route('user.profile.saveProfileImage') }}', {proPicInput: $('#proPicInput').val()}, function () {

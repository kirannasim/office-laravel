            ...
            <form class="replyContent">
                ...
                <div class="composeHeader">
                    ...
                    <div class="subject">
                        ...
                        <input type="text" name="subject" placeholder="Subject" value="RE: {{ $mail->subject }}">
                    </div>
                </div>
                <textarea class="replyTextArea" name="content">
                    <br/>
                    <br/>
                    On {{ $mail->created_at->format('H:i:s a') }}, {{ $mail->mailOwner()->username }} wrote:<br/>
                    ------------------------------------------------------------------------------------------
                    <div style="border-left:2px solid navy;padding-left:10px;">{!! $mail->content !!}</div>
                </textarea>

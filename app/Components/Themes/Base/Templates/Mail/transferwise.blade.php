                    ...
                    <tr>
                        <td class="content_cell header_c active_b brt pt pb"
                            ...
                            <div class="email_row"
                                ...
                                <h4 style="width: 100%; font-size: 16px; margin-left: -50px;margin-top: 100px !important; font-family: sans-serif;">ATTENTION! IMMEDIATE ACTION REQUIRED. SWIFT PAYMENT EEA.</h4>
                                <div class="col_12"
                                    ...
                                    <table class="column" width="100%" border="0" cellspacing="0" cellpadding="0"
                                        ...
                                        <tr>
                                            <td class="column_cell px pt_xs pb_0 logo_c tl sc"
                                                style="box-sizing: border-box;vertical-align: top;width: 100%;min-width: 100%;padding-top: 22px;padding-bottom: 0;font-family: Helvetica, Arial, sans-serif;font-size: 14px;line-height: 20px;mso-line-height-rule: exactly;text-align: left;padding-left: 16px;padding-right: 16px;color: red; font-weight: bold;">
